...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-10 11:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5d4738b8-7080-4a68-bf97-5ff6861ddbf5.git
$ cd 5d4738b8-7080-4a68-bf97-5ff6861ddbf5
```
